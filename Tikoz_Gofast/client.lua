...
function voiturefast()
    ...
    TriggerServerEvent("TikozAlertPopo") 
    ...
    ESX.ShowNotification("Va sur le point que je t'ai mis sur le ~b~GPS~w~, te fais pas ~r~chopper !")
        ...
        while true do 
            ...
            local carretour = Config.Car.Retour
            ...
            while not HasModelLoaded(carretour) do Citizen.Wait(0) end
                ...
                if dist2 <= 2 then            
                    ...
                    if IsControlJustPressed(1, 51) then
                        ...
                        SetPedIntoVehicle(createpnj2, createcar, -1)
                        ...
                        local createretour = CreateVehicle(carretour, Config.Pos.Retour, true, false)

                        SetPedIntoVehicle(createpnj2, createretour, -1)

                        TaskVehicleDriveToCoord(createpnj2, createretour, Config.Pos.Drivecoord2.x, Config.Pos.Drivecoord2.y, Config.Pos.Drivecoord2.z, 8.0, 0, GetEntityModel(carHash), 411, 10.0)
...
function camionfast()
    ...
    Citizen.CreateThread(function()
        ...
        TriggerServerEvent("TikozAlertCamtar") 
